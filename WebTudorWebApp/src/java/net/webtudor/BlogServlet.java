...
import net.webtudor.blog.v1.BlogPostDecoratorHTML;
import net.webtudor.blog.v1.SingletonBlog;
...
public class BlogServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            blogPost.heads.add(new BlogPostTitle("CIM "+Math.random()));
            blogPost.heads.add(new BlogPostHead("bevezeto 0"));
            BlogPostDecoratorHTML htmlBlog=new BlogPostDecoratorHTML(blogPost);
            blog.add(htmlBlog);
            for(BlogPostDecorator b: blog.getPostok()){
                out.println(b.getInfo());
                out.println("<br>--------<br>");
            }
        }
    }
